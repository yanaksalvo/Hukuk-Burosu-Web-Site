...
if(isset($_POST['update_service'])) {
    ...
    $query = "UPDATE services SET title = ?, content = ? WHERE id = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("ssi", $title, $content, $id);
    
    if($stmt->execute()) {
        logActivity($conn, "Hizmet güncellendi: " . $title, "service", "text-success");
...
<head>
    ...
    <title>Hizmet Düzenle - Admin Panel</title>
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title mb-4">Hizmet Düzenle</h2>
                        ...
                        <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="content" name="content" class="form-control" required><?php echo htmlspecialchars($service['content']); ?></textarea>
